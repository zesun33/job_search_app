...
# Provide fallback alias so other modules can import JobAPIManager from this module
try:
    from .indeed_client import JobAPIManager as _JobAPIManager
    JobAPIManager = _JobAPIManager
except Exception:  # circular during initial import, ignore
    pass 